            ...
            <div className='row'>
                ...
                <p>Extend your trading and investment experience even further with our partner platforms</p>
                    ...
                    <div className='col-4 p-3'>
                        <img src='media/images/zerodhaFundhouse.png' style={{width:"25%"}}/>
                    ...
                    <div className='col-4 p-3 mt-5'>
                        ...
                        <p className='text-small text-muted'>Systematic trading platform that allows you to create and basket strategies without coding.</p>
                    </div>
                    <div className='col-4 p-3 mt-5'>
